...
namespace Orders.Backend.Repositories.Implementations
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public async Task<ActionResponse<T>> AddAsync(T entity)
        {
            ...
            { 
                return ExceptionActioinResponse(exception);
            }
        }
        ...
        public async Task<ActionResponse<T>> DeleteAsync(int id)
        {
            ...
            catch
            {
                ...
                {
                    WasSuccess = false,
                    Message = "No se puedde borrar porque tiene registros relacionados",
                };
            }
        }
        ...
        private ActionResponse<T> ExceptionActioinResponse(Exception exception)
        {
            return new ActionResponse<T>
            {
                WasSuccess = false,
